...
测试 faster-whisper 不同模型在 GPU 上的转录速率和准确性
"""
...
class BenchmarkResult:
    ...
    realtime_factor: float  # 转录时间 / 音频时长，越小越好
    language: str
...
def main():
    ...
    models_dir = project_root / "backend" / "models" / "whisper"
